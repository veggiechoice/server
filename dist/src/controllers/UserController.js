...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, usersRepository, userAlreadyExist, encriptedPassword, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (userAlreadyExist) {
                            throw new AppError_1.default('This User Already Exists', 'DuplicityOfUsers');
                        }
