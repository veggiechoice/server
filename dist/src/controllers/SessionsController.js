...
var SessionController = /** @class */ (function () {
    ...
    SessionController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, usersRepository, user, passwordMatched, _b, expiresIn, secret, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (!passwordMatched) {
                            throw new AppError_1.default('Email/password combination does not match', 'UserNotFound');
                        }
