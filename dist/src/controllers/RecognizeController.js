...
var RecognizeController = /** @class */ (function () {
    ...
    RecognizeController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _scan, url, text, isVegan, ingredientsRepository, ingredientsUnion;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _scan = request.query._scan;
                        url = process.env.FILES_URL + "/labels/resized/" + request.filename;
                        text = [];
                        this.storageProvider = new StorageProvider_1.DiskStorageProvider(label_upload_1.default.directory, label_upload_1.default.uploadsFolder + "/resized");
                        return [4 /*yield*/, fetchTextFromImage_1.fetchTextFromImage(url)];
                    case 1:
                        text = _a.sent();
                        if (text.length <= 0)
                            throw new AppError_1.default('Não foi possível verificar este produto', 'NonVegan', 500);
                        return [4 /*yield*/, this.storageProvider.deleteFile(request.filename)];
                    case 2:
                        _a.sent();
                        ...
                        if (!isVegan) {
                            throw new AppError_1.default('Este Produto não é Vegano!', 'NonVegan', 401);
                        }
