...
var CategoriesController = /** @class */ (function () {
    ...
    CategoriesController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, description, categoriesRepository, categories;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, categoriesRepository.create({
                                name: name,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        categoriesRepository = new CategoriesRepository_1.CategoriesRepository();
                        return [4 /*yield*/, categoriesRepository.findAll()];
                    case 1:
                        categories = _a.sent();
                        return [2 /*return*/, response.json({ row: categories, count: categories.length })];
                }
            });
        });
    };
    CategoriesController.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var categoriesRepository, id;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        categoriesRepository = new CategoriesRepository_1.CategoriesRepository();
                        id = request.params.id;
                        return [4 /*yield*/, categoriesRepository.deleteOne(id)];
                    case 1:
                        _a.sent();
