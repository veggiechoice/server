    ...
    S3StorageProvider.prototype.saveFile = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        originalPath = path_1.default.resolve(upload_1.default.directory + "/uploads", file);
                        ContentType = mime_types_1.default.contentType(originalPath);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.client
                                .putObject({
                                Bucket: String(upload_1.default.config.aws.bucket),
                                Key: file,
                                ACL: 'public-read',
                                Body: fileContent,
